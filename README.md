...
**[Budget App]** Mobile web application where you can manage your budget: you have a list of transactions associated with a category, so that you can see how much money you spent and on what.
...
``` bash
git clone git@github.com:dgcuenca/Budget-app.git
```
...
Feel free to check the [issues page](https://github.com/dgcuenca/Budget-app/issues).
...
- **Is there an Entity Relationship Diagram (ERD) that represents this project?**
  ...
  - Yes! 
  <div align="left">
    <img src="./erd_diagram_budget_app.png" alt="ERD diagram" width="540"  height="auto" />
  </div>
